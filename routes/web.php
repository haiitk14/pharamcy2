...
Route::group(['middleware' => 'admin'], function(){
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'report'], function() {
            ...
            Route::get('/mixing', 'Admin\ReportMixingController@index')->name('admin.report.mixing');
            ...
            Route::post('/saveform-mixing', 'Admin\ReportMixingController@saveForm')->name('admin.report.savemixing');
            ...
            Route::get('/getmixing', 'Admin\ReportMixingController@getReportFormula')->name('admin.reportmixing.getreportformula');
