...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2019 at 03:14 AM
...
--
-- Table structure for table `basic_inspection`
--

CREATE TABLE `basic_inspection` (
...
--
-- Table structure for table `inspection_worker`
--

CREATE TABLE `inspection_worker` (
  `id` bigint(20) NOT NULL,
  `reportinspection_id` bigint(20) DEFAULT NULL,
  `rack_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `inspection_worker` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `time` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ck_by` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comments` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IPC` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cost` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `reportinspection`
--

CREATE TABLE `reportinspection` (
  `id` bigint(20) NOT NULL,
  `customrequest_id` bigint(20) DEFAULT NULL,
  `batch_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `personel` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qcpersonel` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_by` bigint(20) DEFAULT NULL,
  `update_by` bigint(20) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Indexes for table `basic_inspection`
--
ALTER TABLE `basic_inspection`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `inspection_worker`
--
ALTER TABLE `inspection_worker`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `reportinspection`
--
ALTER TABLE `reportinspection`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `basic_inspection`
--
ALTER TABLE `basic_inspection`
...
--
-- AUTO_INCREMENT for table `inspection_worker`
--
ALTER TABLE `inspection_worker`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `reportinspection`
--
ALTER TABLE `reportinspection`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
